...
file_name_files = open("VIRAT_S_0102.txt", "r")

file_names = file_name_files.readlines()

video_info_csv = open("VIRAT_S_0102_VIDEO_INFO.csv", "w")
...
for video_file_name in file_names:
    ...
    video_info = MediaInfo.parse(
        "./four-largest-annotations/VIRAT_S_0102_VIDEOS/" + video_file_name + ".mp4"
    )
